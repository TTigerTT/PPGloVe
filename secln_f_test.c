...
long long num_lines,num_threads=1,communication;
...
int main(){
    double dataset1[50000],dataset2[100000],dataset3[150000],dataset4[2000];
    double avg_error=0;
    communication=0;

    for(int i=0;i<50000;i++){
        dataset1[i]=(double)(1023);
    }
    ...
    printf("The dataset 1 communication cost is %lld%\n",communication);
    ...
    printf("The dataset2 communication cost is %lld%\n",communication);
    ...
    printf("The dataset3 communication cost is %lld%\n",communication);
 ...
 communication =0; 
  ...
  start=clock();
    ...
    printf("calculate use %f secs\n",(double)(end-start)/CLOCKS_PER_SEC);
    printf("The dataset2 average error is %.9f\n", avg_error);
    printf("The dataset 2 communication cost is %lld%\n",communication);
  ...
  start=clock();
    ...
    printf("calculate use %f secs\n",(double)(end-start)/CLOCKS_PER_SEC);
    printf("The dataset3 average error is %.9f\n", avg_error);
    printf("The dataset 3 communication cost is %lld%\n",communication);
